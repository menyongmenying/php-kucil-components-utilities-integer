...
abstract class IntegerCore implements IntegerInterface
{
    ...
    public static function positiveNumber(?int $int = null): ?int
    {
        ...
        if ($int !== null) {
            ...
            if (!self::isPositiveNumber($result)) {
                $result = -$result; 
            }
        }
     ...
     * 
     */
    public static function roundNearest(?int $int = null, ?int $precision = null): ?int
    {
        # Inisasi
     ...
     * 
     */
    public static function roundUp(?int $int = null, ?int $precision = null): ?int
    {
        # Inisasi
        $precision = self::positiveNumber($precision);
        $result = null;
     ...
     * 
     */
    public static function roundDown(?int $int = null, ?int $precision = null): ?int
    {
        # Inisasi
        $precision = self::positiveNumber($precision);
        $result = null;
     ...
     * 
     */
    public static function round(?int $int = 0, ?int $precision = 0, ?IntegerRoundOptions $option = IntegerRoundOptions::NEAREST): ?int
    {
        # Inisasi
        $result = null;
